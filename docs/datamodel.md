আগের চ্যাপ্টারে আমরা Nautobot 3.0 ইনস্টল করলাম। নির্ভর কমিউনিকেশনের এনওসি টিম এখন একটা চালু নটবট ইনস্ট্যান্স পেয়েছে। কিন্তু এখনও কোনো ডেটা নেই - খালি একটা সিস্টেম। ডেটা এন্ট্রি শুরু করার আগে বুঝতে হবে নটবট কীভাবে নেটওয়ার্ক ডেটা স্টোর করে, কীভাবে বিভিন্ন জিনিস একে অপরের সাথে সম্পর্কিত।
