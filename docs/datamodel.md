...
#### ভিএলএএন - লেয়ার ২ সেগমেন্টেশন

ভিএলএএন দিয়ে একই ফিজিক্যাল নেটওয়ার্ক কে লজিক্যাল ভাগে আলাদা করা যায়।

নির্ভর কমিউনিকেশনের ভিএলএএন স্ট্রাকচার:
...
যদি একই ভিএলএএন আইডি বিভিন্ন সাইটে ভিন্ন পারপাস এ ব্যবহার করতে চান, তাহলে ভিএলএএন গ্রুপ ব্যবহার করুন।
...
এভাবে নটবট জানে ঠিক কোন ইন্টারফেস এ আপলিংক আছে।
...
নটবট অনেক ভ্যালিডেশন করে যাতে ভুল ডেটা ঢুকতে না পারে।

#### রেফারেনশিয়াল ইন্টেগ্রিটি

যদি একটা লোকেশন মুছতে চান যেখানে ডিভাইস আছে, নটবট বলবে:
