...
প্রথমে একবার নটবট ইউআই এর সাথে পরিচিত হয়ে নিই।
...
নটবট সিএসভি পার্স করবে এবং একটা প্রিভিউ দেখাবে:
...
নির্ভর কমিউনিকেশনের নেটওয়ার্কে বিভিন্ন ধরনের ট্রাফিক আছে - ম্যানেজমেন্ট, কাস্টমার, আপলিংক। এগুলো আলাদা করার জন্য ভিএলএএন ব্যবহার করা হয়।

##### ভিএলএএন গ্রুপ তৈরি করা (অপশনাল কিন্তু রেকমেন্ডেড)

ভিএলএএন গ্রুপ দিয়ে ভিএলএএন গ্রুপস অর্গানাইজ করা যায়। বিশেষ করে যখন একই ভিএলএএন গ্রুপস আইডি বিভিন্ন সাইটে ভিন্ন পারপাস এ ব্যবহার হয়।
...
এখন অ্যাকচুয়াল ভিএলএএন তৈরি করব।
...
**সাইট-অ্যাগনস্টিক ভিএলএএন (সব সাইটে একই):**

কিছু ভিএলএএন সব সাইটে একই পারপাস এ ব্যবহার হয়:
...
এখন ভিএলএএন এর সাথে আইপি প্রিফিক্স লিঙ্ক করব।
...
নটবট অটোমেটিকালি ডুপ্লিকেট নেমস প্রিভেন্ট করে, কিন্তু ডাবল-চেক করা ভালো।
