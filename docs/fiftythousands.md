দুই বছর আগে নির্ভর কমিউনিকেশন শুরু করেছিল মাত্র দুটো পপ নিয়ে - মিরপুর এবং উত্তরা। প্রায় ৫ হাজার কাস্টমার। তখন তারা নটবট সেটআপ করেছিল। সেই পরিকল্পনা অনুযায়ী কাজ করেছে, সফল হয়েছে।

এখন ২০২৬ সাল। নির্ভর কমিউনিকেশনের গ্রোথ হয়েছে বিশাল। বর্তমানে নর্থ ঢাকায় তাদের আটটা পপ, প্রায় পঞ্চাশ হাজার কাস্টমার। আর সবচেয়ে বড় কথা - তারা এখনও সেই একই নটবট সিস্টেম ব্যবহার করছে যেটা দুই বছর আগে সেটআপ করেছিল।

কিন্তু স্কেল বাড়ার সাথে সাথে নতুন চ্যালেঞ্জ এসেছে। এই চ্যাপ্টারে আমরা দেখব কীভাবে নির্ভর কমিউনিকেশন সেই চ্যালেঞ্জগুলো সামলেছে, কী কী পরিবর্তন করেছে, আর কীভাবে নটবট তাদের এই স্কেলিং জার্নিতে সাহায্য করেছে।
...
এই সব ভিল্যান নটবটে CSV দিয়ে বাল্ক ইমপোর্ট করা হয়েছে।
...
৩. **Network Engineer** নটবট আপডেট করে:
...
১৫০+ ডিভাইস, ৮টা সাইট, হাজার হাজার আইপি - নটবট UI স্লো হয়ে যাচ্ছিল না তো?

### Performance Optimization

নির্ভর কমিউনিকেশন কিছু optimization করেছে:
...
নির্ভর কমিউনিকেশনের CTO জাহাঙ্গীর সাহেবের কিছু পরামর্শ:
...
"নটবট শুধু একজনের জিনিস না। পুরো টিম যদি ইউজ না করে, তাহলে ডেটা আউটডেটেড হয়ে যায়। প্রপার ট্রেনিং দিন, documentation রাখুন।"
...
নির্ভর কমিউনিকেশন এখন ৫০ হাজার কাস্টমারে স্ট্যাবল। তাদের লক্ষ্য পরের দুই বছরে (২০২৮) ১ লক্ষ কাস্টমার। সেজন্য তারা এখন অটোমেশনের দিকে যাচ্ছে। পরের চ্যাপ্টারে আমরা দেখব কীভাবে API এবং Python দিয়ে নটবটকে অটোমেট করা যায়।
