নির্ভর কমিউনিকেশন আইএসপি হিসেবে বেশ নাম করেছে। ঢাকা নর্থ জোনে মূলতঃ তাদের নেটওয়ার্ক। বর্তমানে মিরপুর এবং উত্তরায় দুটো পপ, প্রায় ৫ হাজার কাস্টমার। তারা সিদ্ধান্ত নিয়েছে এক্সেল শিট/গুগল শিট এবং হাতে আঁকা ডায়াগ্রাম ছেড়ে একটা প্রপার Network Source of Truth সিস্টেম বানাবে। তাদের লক্ষ্য পরের দুই বছরে ৫০ হাজার কাস্টমারে পৌঁছানো, আর তারপর ১ লক্ষ। এজন্য দরকার একটা শক্ত ফাউন্ডেশন। সেই ফাউন্ডেশনের নাম Nautobot 3.0।
...
নির্ভর কমিউনিকেশনএই কারণে 3.0 বেছে নিয়েছে। তারা জানে ভবিষ্যতে scaling করতে হবে, তাই শুরু থেকেই সবচেয়ে আধুনিক ভার্সন দিয়ে শুরু করছে।

### সিস্টেম রিকোয়ারমেন্ট

নটবট চালাতে হলে একটা লিনাক্স সার্ভার দরকার। নির্ভর কমিউনিকেশনের ক্ষেত্রে তারা একটা ডেডিকেটেড Ubuntu server সেটআপ করেছে।
...
নির্ভর কমিউনিকেশন এই পদ্ধতিটাই production-এ ব্যবহার করেছে। এটা official `nautobot-docker-compose` repository এবং Poetry ব্যবহার করে — plugin management এবং version upgrade অনেক সহজ হয়।

#### অটোমেটেড ডেপ্লয়মেন্ট স্ক্রিপ্ট

নির্ভর কমিউনিকেশন একটা automated deployment script তৈরি করেছে যা সব কিছু একসাথে করে দেয়:
...
একটা নতুন Ubuntu 24.04 সার্ভার নিন। নির্ভর কমিউনিকেশন একটা VM ব্যবহার করেছে তাদের NOC-এর ভেতরে।
...
Poetry হলো Python dependency management টুল। নটবটের plugin management এবং build process Poetry দিয়ে চলে।
...
এই পদ্ধতিতে Docker ছাড়া সরাসরি সার্ভারে নটবট ইনস্টল করা হয়। Docker ব্যবহারের সুযোগ না থাকলে বা সম্পূর্ণ নিয়ন্ত্রণ চাইলে এই পদ্ধতি ব্যবহার করুন।
...
নটবট চালু হওয়ার পর নির্ভর কমিউনিকেশন দুটো গুরুত্বপূর্ণ plugin যোগ করেছে।
