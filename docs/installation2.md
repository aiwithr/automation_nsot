...
নটোবট চালাতে হলে একটা লিনাক্স সার্ভার দরকার। নির্ভর কমিউনিকেশনের ক্ষেত্রে তারা একটা ডেডিকেটেড উবুন্টু (Ubuntu) সার্ভার সেটআপ করেছে।
...
নটোবট ইনস্টল করার দুটো প্রধান উপায়:
...
#### স্টেপ ৬: পাইথন ভার্সন এবং নটোবট ভার্সন সেট করা
...
এই পদ্ধতিতে ডকার ছাড়া সরাসরি সার্ভারে নটোবট ইনস্টল করা হয়। ডকার ব্যবহারের সুযোগ না থাকলে বা সম্পূর্ণ নিয়ন্ত্রণ চাইলে এই পদ্ধতি ব্যবহার করুন।
...
নটোবট চালু হওয়ার পর নির্ভর কমিউনিকেশন দুটো গুরুত্বপূর্ণ প্লাগইন যোগ করেছে।
