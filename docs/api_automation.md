...
জাহাঙ্গীর সাহেব বললেন, "এভাবে চলবে না। আমাদের অটোমেশন দরকার। পাইথন স্ক্রিপ্ট লিখে নটোবট এপিআই দিয়ে কাজ করা যায়।"

### পাইনটবট - পাইথন থেকে নটোবট

পাইনটবট হলো একটা পাইথন লাইব্রেরি যেটা নটোবট এপিআই এর সাথে কাজ করা সহজ করে দেয়।
...
নটোবট → প্রোফাইল → এপিআই টোকেনস → + অ্যাড টোকেন
