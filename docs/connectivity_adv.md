আগের চ্যাপ্টারে আমরা বেসিক ডেটা এন্ট্রি শিখলাম - লোকেশন, ডিভাইস, আইপি, ভিল্যান, ক্যাবল। নির্ভর কমিউনিকেশনের NOC টিম এখন দৈনন্দিন কাজে নটবট ব্যবহার শুরু করেছে। কিন্তু কিছুদিন পরেই তারা বুঝতে পারল বেসিক ফিচারগুলো যথেষ্ট না। 
...
নটবটে অনেক built-in ফিল্ড আছে - name, location, serial number, status। কিন্তু প্রতিটা অর্গানাইজেশনের নিজস্ব কিছু ডেটা ট্র্যাক করার দরকার হয় যা স্ট্যান্ডার্ড ফিল্ডে নেই। এজন্যই Custom Fields।
...
নির্ভর কমিউনিকেশন আরো কয়েকটা Custom Field তৈরি করেছে:
...
শুধু critical ট্যাগ ওয়ালা ডিভাইস দেখাবে। নির্ভর কমিউনিকেশনের ক্ষেত্রে:
...
নটবটে Groups দিয়ে permissions ম্যানেজ করা হয়। একটা গ্রুপে permissions সেট করুন, তারপর ইউজারদের সেই গ্রুপে যোগ করুন।
...
Permissions:
  ...
  Staff status: ☑ (চেক করুন - এটা থাকলে নটবট admin প্যানেলে access পাবে)
